...
class Microcontrollers extends Items{
    Microcontrollers(){
        super();
        this.type = "Micro-controller";
    }
    Microcontrollers(String name, String type, String description, float price){
        super(name,type,description,price);
    }

    public void displayItems(){
        System.out.println("Item Name: "+ name);
        System.out.println("Item Category: Micro-controller");
        System.out.println("Item Price: "+ price);
        System.out.println("Item Description: "+ description);
    }
//    public void editMicrocontrollers(){
//        int ch;
